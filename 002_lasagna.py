...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :param elapsed_bake_time: int - baking time already elapsed.
    :return: int - the preparation time in minutes derived from 'PREPARATION_TIME'
                    and the bake time in minutes derived from 'EXPECTED_BAKE_TIME'.

    Function that takes the number of layers you want to add to the lasagna
    and the actual minutes the lasagna has been in the oven as arguments and
    returns how many minutes you have been cooking the lasagna.
    """
